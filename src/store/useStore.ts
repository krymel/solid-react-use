...
export type UseStore<T extends object = {}, O = UseStoreOptions<T>> = <T extends object = {}>(...[store, options]: {} extends T ? 
    [store?: T | Store<T>, options?: O] : 
    [store: T | Store<T>, options?: O]) => [get: Store<T>, set: SetStoreFunction<T>];
